...
string accountName = "storewjacb"; // Replace with your storage account name
...
await File.WriteAllTextAsync(localFilePath, "HELLOCITO OTRA VEZ PARA ESTE EXAMEN DEL AZ-204 QUE LLEGA A SU FINAL :( ");
